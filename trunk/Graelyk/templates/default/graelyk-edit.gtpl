...
[% headTitle = message(code:"default.edit.label", args:[entityName]) %]
[% headIncludes = """
...
[% include("/WEB-INF/includes/header.gtpl") %]
        <div class="body">
            <h1>[% g_message code:"default.edit.label", args:[entityName] %]</h1>
            [% if(flash.message) { %]
            ...
            [% g_form(method:"post" <%= multiPart ? ', enctype:"multipart/form-data"' : '' %>) { %]
                ...
                <div class="buttons">
					[% if(isActionAllowed("update")) { %]
						<span class="button">[% g_actionSubmit class:"save", action:"update", value:message(code: 'default.button.update.label', default: 'Update') %]</span>
					[% } %]
