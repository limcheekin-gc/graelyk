...
import groovyx.gaelyk.graelyk.domain.ClassPropertyFetcher

/**
 * Builder used as a delegate within the "constraints" closure of GraelykDomainClass instances 
 * 
            ...
            for (Object o : attributes.keySet()) {
                ...
                if (cp.supportsContraint(constraintName)) {
                    ...
                    if (ConstrainedProperty.hasRegisteredConstraint(constraintName)) {
						...
						System.out.println("Property [" + cp.getPropertyName() + "] of domain class " + targetClass.getName() + " has type [" + cp.getPropertyType().getName() + "] and doesn't support constraint [" + constraintName + "]. This constraint will not be checked during validation.");
                    }
                    else {
